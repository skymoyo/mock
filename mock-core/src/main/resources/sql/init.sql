...
INSERT INTO mock.mock_config (id, mock_code, name, route, create_time, create_user, update_time, update_user) VALUES (1, '00000001', '返回String', '/test/dubbo/provider/service/TestService/helloString', '2022-07-25 12:04:01', 'sys', '2022-07-26 13:37:57', 'sys');
INSERT INTO mock.mock_config (id, mock_code, name, route, create_time, create_user, update_time, update_user) VALUES (2, '00000002', '返回Integer', '/test/dubbo/provider/service/TestService/helloInteger', '2022-07-25 12:04:40', 'sys', '2022-07-26 13:37:57', 'sys');
INSERT INTO mock.mock_config (id, mock_code, name, route, create_time, create_user, update_time, update_user) VALUES (3, '00000003', '返回int', '/test/dubbo/provider/service/TestService/helloInt', '2022-07-26 13:28:03', 'sys', '2022-07-26 13:38:01', 'sys');
INSERT INTO mock.mock_config (id, mock_code, name, route, create_time, create_user, update_time, update_user) VALUES (4, '00000004', '返回list', '/test/dubbo/provider/service/TestService/helloList', '2022-07-26 13:52:45', 'sys', '2022-07-26 13:52:59', 'sys');
INSERT INTO mock.mock_config (id, mock_code, name, route, create_time, create_user, update_time, update_user) VALUES (5, '00000005', '返回Map', '/test/dubbo/provider/service/TestService/helloMap', '2022-07-26 14:03:47', 'sys', '2022-07-26 14:03:47', 'sys');
INSERT INTO mock.mock_config (id, mock_code, name, route, create_time, create_user, update_time, update_user) VALUES (6, '00000006', '返回对象', '/test/dubbo/provider/service/TestService/helloObject', '2022-07-26 14:19:39', 'sys', '2022-07-26 14:19:39', 'sys');
INSERT INTO mock.mock_config (id, mock_code, name, route, create_time, create_user, update_time, update_user) VALUES (7, '00000007', '无返回', '/test/dubbo/provider/service/TestService/helloVoid', '2022-07-26 14:35:07', 'sys', '2022-07-26 14:35:07', 'sys');
...
CREATE TABLE `mock_rule` (
  ...
  `rule_result` varchar(255) NOT NULL COMMENT '返回结果',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_user` varchar(10) DEFAULT NULL COMMENT '创建人',
  `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `update_user` varchar(10) DEFAULT NULL COMMENT '更新人',
...
INSERT INTO mock.mock_rule (id, mock_code, rule_code, rule_name, rule_type, rule_result, create_time, create_user, update_time, update_user) VALUES (6, '00000006', '10000006', '返回Object', 10, '{"id":10086,"name":"mock Map","desc":"返回对象"}', '2022-07-26 14:23:11', 'sys', '2022-07-26 14:23:11', 'sys');
...
INSERT INTO mock.mock_condition (id, rule_code, condition_type, condition_key, condition_value, create_time, create_user, update_time, update_user) VALUES (1, '10000001', 'route', null, '/test/dubbo/provider/service/TestService/helloString', '2022-07-26 03:23:37', 'sys', '2022-07-26 14:06:18', 'sys');
...
INSERT INTO mock.mock_condition (id, rule_code, condition_type, condition_key, condition_value, create_time, create_user, update_time, update_user) VALUES (3, '10000002', 'route', '', '/test/dubbo/provider/service/TestService/helloInteger', '2022-07-26 06:41:05', 'sys', '2022-07-26 14:06:18', 'sys');
...
INSERT INTO mock.mock_condition (id, rule_code, condition_type, condition_key, condition_value, create_time, create_user, update_time, update_user) VALUES (5, '10000003', 'route', null, '/test/dubbo/provider/service/TestService/helloInt', '2022-07-26 10:48:31', 'sys', '2022-07-26 14:06:18', 'sys');
...
INSERT INTO mock.mock_condition (id, rule_code, condition_type, condition_key, condition_value, create_time, create_user, update_time, update_user) VALUES (7, '10000004', 'route', '', '/test/dubbo/provider/service/TestService/helloList', '2022-07-26 10:48:31', 'sys', '2022-07-26 14:06:18', 'sys');
...
INSERT INTO mock.mock_condition (id, rule_code, condition_type, condition_key, condition_value, create_time, create_user, update_time, update_user) VALUES (9, '10000005', 'route', null, '/test/dubbo/provider/service/TestService/helloMap', '2022-07-26 14:07:28', 'sys', '2022-07-26 14:07:28', 'sys');
...
INSERT INTO mock.mock_condition (id, rule_code, condition_type, condition_key, condition_value, create_time, create_user, update_time, update_user) VALUES (11, '10000006', 'route', null, '/test/dubbo/provider/service/TestService/helloObject', '2022-07-26 14:24:25', 'sys', '2022-07-26 14:24:25', 'sys');
...
INSERT INTO mock.mock_condition (id, rule_code, condition_type, condition_key, condition_value, create_time, create_user, update_time, update_user) VALUES (13, '10000007', 'route', null, '/test/dubbo/provider/service/TestService/helloObject', '2022-07-26 14:24:25', 'sys', '2022-07-26 14:24:25', 'sys');
...
INSERT INTO mock.mock_condition (id, rule_code, condition_type, condition_key, condition_value, create_time, create_user, update_time, update_user) VALUES (15, '10000008', 'route', null, '/test/dubbo/provider/service/TestService/helloVoid', '2022-07-26 14:36:27', 'sys', '2022-07-26 14:36:27', 'sys');
