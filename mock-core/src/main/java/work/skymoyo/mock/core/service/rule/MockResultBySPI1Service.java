...
public class MockResultBySPI1Service implements MockResultService {
    ...
    public String getResult(MockReq req, MockRule mockRule) {
        ...
        return "[{\"name\":\"SPI_1\",\"age\":12,\"childs\":[{\"name\":\"SPI_11\",\"age\":1,\"childs\":[{\"name\":\"SPI_111\",\"age\":1}]}]},{\"name\":\"bar\",\"age\":23,\"childs\":[{\"name\":\"bar1\",\"age\":1,\"childs\":[{\"name\":\"bar11\",\"age\":1}]},{\"name\":\"bar2\",\"age\":2,\"childs\":[{\"name\":\"bar21\",\"age\":412}]}]}]";
    }
