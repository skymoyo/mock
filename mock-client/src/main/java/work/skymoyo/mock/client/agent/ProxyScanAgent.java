    ...
    private void createMethod(String clazzName, CtMethod method) {
        ...
        try {
            ...
            method.insertBefore("try{"
                    ...
                    + " java.lang.reflect.Method method  = work.skymoyo.mock.client.utils.BeanMockUtil.getMethod($class,\"" + method.getName() + "\",$sig);"
//                    + " java.lang.reflect.Type type = work.skymoyo.mock.client.utils.BeanMockUtil.getReturnType(method);"
//                    + " java.lang.reflect.Type type = $class.getMethod(\"" + method.getName() + "\",$sig).getGenericReturnType();"
                    + " Object obj  =  work.skymoyo.mock.client.utils.MethodMockUtil.proxyInvoker( method ,  $args);"
